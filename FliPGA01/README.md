...
Flip01 is a small 8-bit processor designed by us and developed at the logic level, featuring an Harvard architecture. The entire project is open source. All files mentioned are available on [GitHub](https://github.com/pescetti-studio/Flip01-CPU) and on [Patreon](https://www.patreon.com/c/PescettiStudio) (_for free_).
...
```
These choices were made because the FPGA used did not have sufficient resources to implement the original Flip01 CPU logic on the board; therefore, it was necessary to simplify the circuit.
...
Figure 1: Machine code to copy to the memories files
...
Figure 2: MEM1 data file
Figure 3: MEM2 instructions file
...
```
Figure 4: Spreadsheet view: pin assignment
...
Figure 5: Electrical schematic external circuit
